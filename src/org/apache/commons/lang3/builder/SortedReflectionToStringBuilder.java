 ...
 * @since 2.0
 */
public class SortedReflectionToStringBuilder extends ToStringBuilder {
    ...
    public static <T> String toString(
        ...
        return new SortedReflectionToStringBuilder(object, style, null, reflectUpToClass, outputTransients, outputStatics)
                .toString();
    }
    ...
    public static <T> String toString(
        ...
        return new SortedReflectionToStringBuilder(object, style, null, reflectUpToClass, outputTransients, outputStatics, excludeNullValues)
                .toString();
    }
    ...
    public static String toStringExclude(final Object object, final String... excludeFieldNames) {
        return new SortedReflectionToStringBuilder(object).setExcludeFieldNames(excludeFieldNames).toString();
    }
     ...
     */
    public SortedReflectionToStringBuilder(final Object object) {
     ...
     *             if the Object passed in is {@code null}
     */
    public SortedReflectionToStringBuilder(final Object object, final ToStringStyle style) {
     ...
     *             if the Object passed in is {@code null}
     */
    public SortedReflectionToStringBuilder(final Object object, final ToStringStyle style, final StringBuffer buffer) {
     ...
     * @since 2.1
     */
    public <T> SortedReflectionToStringBuilder(
    ...
    protected void collectFields(HashMap<String, Object> fieldMap, final Class<?> clazz) {
        if (clazz.isArray()) {
     ...
     * @return this
     */
    public SortedReflectionToStringBuilder reflectionAppendArray(final Object array) {
     ...
     * @return {@code this}
     */
    public SortedReflectionToStringBuilder setExcludeFieldNames(final String... excludeFieldNamesParam) {
	...
	public String toString() {
		...
		for (String key : keySet) {
	        this.append(key, fieldMap.get(key));
		}
